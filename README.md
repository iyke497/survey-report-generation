...
```
To run the project locally, you have to have docker and dcoker compose installed.
At the root of the directory run the following commands to build and run the project:
```bash
